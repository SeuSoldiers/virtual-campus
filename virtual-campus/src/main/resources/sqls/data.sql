...
-- Insert test reservation records
...
INSERT OR IGNORE INTO course (courseId, courseName, courseTeacher, courseCredit, courseCapacity, coursePeopleNumber, courseTime, courseLocation)
VALUES
-- 周一课程
