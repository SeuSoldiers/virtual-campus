        ...
        new Thread(() -> {
            try {
                ...
                Request request = new Request.Builder()
                        .url("http://localhost:8080/api/course/timetable/" + studentId)
            ...
            for (int dayIdx = 0; dayIdx < DAYS.length; dayIdx++) {
                ...
                for (Course course : coursesInSlot) {
                    ...
                    courseBox.setOnMouseEntered(e -> {
                        courseBox.setStyle("-fx-background-color: #bbdefb; -fx-padding: 8; -fx-border-color: #90caf9; -fx-border-radius: 5; -fx-background-radius: 5;");
                    });
